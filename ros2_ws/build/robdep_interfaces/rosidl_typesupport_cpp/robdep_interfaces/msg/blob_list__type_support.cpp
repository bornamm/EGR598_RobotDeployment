...
static const _BlobList_type_support_symbol_names_t _BlobList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robdep_interfaces, msg, BlobList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robdep_interfaces, msg, BlobList)),
  }
};
...
{
  return &::robdep_interfaces::msg::rosidl_typesupport_cpp::BlobList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robdep_interfaces, msg, BlobList)() {
  return get_message_type_support_handle<robdep_interfaces::msg::BlobList>();
}
